const name = 'CurationToolsDataSync'; //todo: change the service name, match shared infrastructure name
...
export const config = {
  ...
  shortName: 'CTSYNC', //change to your service name, limit to 6 characters, match shared-infrastructure short name
  environment,
  domain,
  codePipeline: {
    githubConnectionArn,
    repository: 'pocket/curation-tools-data-sync', //TODO: Change to your github repository before first deployment
    branch,
  },
  graphqlVariant,
  cacheNodes,
